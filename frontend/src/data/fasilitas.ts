    ...
    items: [
      {
        ...
        keterangan: 'Pusat pelayanan administrasi dan pemerintahan Gampong Madat.',
      },
      {
        nama: 'Kantor Camat Madat',
        keterangan: 'Kantor pemerintahan Kecamatan Madat yang berkedudukan di Gampong Madat.',
      },
      {
        nama: 'Kantor Urusan Agama (KUA)',
        keterangan: 'Layanan pencatatan nikah dan urusan keagamaan tingkat kecamatan.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        keterangan: 'Masjid utama sebagai pusat ibadah dan kegiatan keagamaan warga.',
      },
      {
        nama: 'Meunasah Madat',
        keterangan: 'Tempat ibadah, pengajian, sekaligus balai musyawarah gampong.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        keterangan: 'Pusat Kesehatan Masyarakat yang melayani warga se-Kecamatan Madat.',
      },
    ],
  },
  {
    ...
    icon: 'shield',
    items: [
      { nama: 'Polsek Madat', keterangan: 'Kepolisian Sektor Kecamatan Madat.' },
      { nama: 'Koramil Madat', keterangan: 'Komando Rayon Militer Kecamatan Madat.' },
    ],
  },
];
